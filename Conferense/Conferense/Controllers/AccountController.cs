    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                FullName = model.FullName, Job_Education = model.Job_Education,
                    Scientist = model.Scientist, Participation = model.Participation,
                    Degree = model.Degree, PhoneNumber = model.PhoneNumber, Status = "U"};
