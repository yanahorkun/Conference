...
namespace Conferense.Models
{
    ...
    {
        [Required]
        [Display(Name = "Адреса електронної скриньки")]
        [EmailAddress]
        public string Email { get; set; }
    ...
    public class RegisterViewModel
    {
        ...
        [Required]
        [StringLength(100, ErrorMessage = "Значення {0} повинно мати не меньше {2} символов.", MinimumLength = 6)]
        [Display(Name = "Ім'я та Прізвище")]
        public string FullName { get; set; }

        [Required]
        [StringLength(100, ErrorMessage = "Значення {0} повинно мати не меньше {2} символов.", MinimumLength = 6)]
        [Display(Name = "Місце роботи/навчання")]
        public string Job_Education { get; set; }

        [Required]
        [StringLength(100, ErrorMessage = "Значення {0} повинно мати не меньше {2} символов.", MinimumLength = 6)]
        [Display(Name = "Вченне звання")]
